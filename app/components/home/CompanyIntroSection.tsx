      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-3">
          {introPoints.map((item) => (
            <div
              key={item.title}
              className="group rounded-lg border border-zinc-200 bg-[#f5efe4] p-5 transition hover:-translate-y-1 hover:border-sky-300 hover:bg-[#fff8ed] hover:shadow-soft-panel"
            >
