...
export function CareersSection() {
  ...
  return (
    <section id="careers" className="border-y border-zinc-200 bg-[#fff8ed] py-20 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="hiring-border rounded-lg bg-[#fff8ed] p-[1px] shadow-soft-panel">
          <div className="grid overflow-hidden rounded-lg bg-zinc-950 text-[#fff8ed] lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div className="relative min-h-[320px] overflow-hidden border-t border-[#fff8ed]/10 bg-zinc-900 lg:border-l lg:border-t-0">
                  ...
                  <div key={row} className="flex overflow-hidden">
                    ...
                    >
                      {doubledRoles.map((role, index) => (
                        <span
                          key={`${role}-${index}-${row}`}
                          className="inline-flex h-12 items-center gap-2 rounded-lg border border-[#fff8ed]/10 bg-[#fff8ed] px-4 text-sm font-semibold text-zinc-950 shadow-xl"
                        >
