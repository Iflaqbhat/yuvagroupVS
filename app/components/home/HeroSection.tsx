...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden border-b border-zinc-800 bg-zinc-950 text-[#fff8ed]">
      <video
      ...
      >
        ...
        >
          <motion.div variants={fadeUp}>
            <h1 className="max-w-[22rem] break-words text-4xl font-semibold leading-[1.08] text-[#fff8ed] sm:max-w-5xl sm:text-6xl sm:leading-[1.02] lg:text-7xl">
          ...
          >
            ...
            <a
              href="/projects"
              className="inline-flex h-11 items-center justify-center gap-2 rounded-md border border-sky-300/50 bg-sky-500/10 px-5 text-sm font-semibold text-[#fff8ed] shadow-sm backdrop-blur-md transition hover:-translate-y-0.5 hover:border-sky-200 hover:bg-sky-500/20"
            >
              View projects
