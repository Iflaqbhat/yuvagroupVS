...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden border-b border-ink/70 bg-ink text-[#ffffff]">
      <video
        ...
        >
          <motion.div variants={fadeUp}>
            <h1 className="max-w-[22rem] break-words text-4xl font-semibold leading-[1.08] text-[#ffffff] sm:max-w-5xl sm:text-6xl sm:leading-[1.02] lg:text-7xl">
              ...
              <span className="text-clay drop-shadow-[0_0_22px_rgba(14,165,233,0.45)]">
                clarity
              </span>{" "}
          ...
          <motion.p
            variants={fadeUp}
            className="mt-6 w-full max-w-[22rem] break-words text-base leading-7 text-sand/90 sm:max-w-2xl sm:text-lg"
          >
          ...
          >
            <a
              href="/contact"
              className="inline-flex h-11 items-center justify-center gap-2 rounded-md bg-clay px-5 text-sm font-semibold text-ink shadow-lg shadow-ink/40 ring-1 ring-sand/40 transition hover:-translate-y-0.5 hover:bg-bronze hover:text-sand hover:ring-sand/60"
            >
            ...
            <a
              href="/projects"
              className="inline-flex h-11 items-center justify-center gap-2 rounded-md border border-clay/70/50 bg-bronze-deep/10 px-5 text-sm font-semibold text-[#ffffff] shadow-sm backdrop-blur-md transition hover:-translate-y-0.5 hover:border-clay/50 hover:bg-bronze-deep/20"
            >
              View projects
